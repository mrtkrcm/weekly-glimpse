...
describe('Validation', () => {
  ...
  it('should invalidate a task with long title', () => {
    const taskData = {
      title: 'This is a very long title that exceeds the maximum length of 100 characters. This is a very long title that exceeds the maximum length of 100 characters.',
      description: 'Test Description',
      dueDate: '2024-03-25T12:00:00.000Z',
      priority: TASK_PRIORITY.MEDIUM,
      status: TASK_STATUS.TODO
