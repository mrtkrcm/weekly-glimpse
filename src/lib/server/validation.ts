...
export const taskInsertSchema = createInsertSchema(tasks).omit({ id: true, createdAt: true, updatedAt: true });
...
export const taskSchema = z.object({
  ...
  priority: z.enum([TASK_PRIORITY.LOW, TASK_PRIORITY.MEDIUM, TASK_PRIORITY.HIGH, TASK_PRIORITY.NORMAL]).default(TASK_PRIORITY.NORMAL),
